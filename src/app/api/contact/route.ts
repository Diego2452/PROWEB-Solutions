...
<!DOCTYPE html>
<html>
<head><meta charset="utf-8" /><title>Nuevo Mensaje - PROWEB Solutions</title></head>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0a0a0a;padding:40px 20px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:#141414;border-radius:16px;overflow:hidden;border:1px solid #2a2a2a;">
        <tr><td style="background:#C4281C;padding:28px 36px;">
          <h1 style="margin:0;color:#ffffff;font-size:22px;font-weight:600;letter-spacing:-0.02em;">PROWEB Solutions</h1>
          <p style="margin:4px 0 0;color:rgba(255,255,255,0.75);font-size:13px;">Nuevo mensaje de contacto</p>
        </td></tr>
        ...
        <tr><td style="padding:20px 36px;border-top:1px solid #2a2a2a;">
          <p style="margin:0;font-size:12px;color:#555;text-align:center;">© 2025 PROWEB Solutions · ventas.prowebsolutionscr@gmail.com</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
